...
public class CommandReceiverImp implements CommandReceiver {
    ...
    private HiPanelController hiPanelController;
...
//                    }
    ...
    @Override
    public void setHiPanelController(HiPanelController hiPanelController) {
        this.hiPanelController = hiPanelController;
    }
