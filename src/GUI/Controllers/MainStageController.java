...
public class MainStageController implements Initializable {
    ...
    private Pane pane;
    @FXML
    private Text aboutFagotsText;
    @FXML
    private Text hiText;
    @FXML
    private Pane groupMap;
    @FXML
    private Pane executeCommand;
    @FXML
    private Pane aboutFagots;
    @FXML
    ...
    @FXML
    private Button executeCommandsBtn;
    @FXML
    ...
    @FXML
    private TextField studentsCountFilter;
    @FXML
    private ChoiceBox<String> formOfEducationFilter;
    @FXML
    private ChoiceBox<String> semesterEnumFilter;
    @FXML
    private TextField adminNameFilter;
    @FXML
    ...
    @FXML
    private TextField idArgumentField;
    @FXML
    private TitledPane aboutGroupTitiledPane;
    @FXML
    private TitledPane aboutGroupAdminTitledPane;
    @FXML
    ...
    @FXML
    private TextField adminGroupField;
    @FXML
    private TextField adminHeightField;
    @FXML
    private ComboBox<String> adminEyeColorComboBox;
    @FXML
    private ComboBox<String> adminHairColorComboBox;
    @FXML
    private ComboBox<String> adminNationalityComboBox;
    @FXML
    private ComboBox<String> commandChoiseComboBox;
    @FXML
    private Button executeCommandBtn;

    @FXML
    private Button setRu;
    @FXML
    private Button setFr;
    @FXML
    private Button setNo;
    @FXML
    private Button setEsNI;
    ...
    private void commandProcessing(ActionEvent actionEvent) {
        ...
        if (commandName.matches("add|remove_lower|remove_greater")) {
            aboutGroupTitiledPane.setDisable(false);
            aboutGroupAdminTitledPane.setDisable(false);
            idArgumentField.setDisable(true);
        } else if (commandName.equals("count_by_group_admin")) {
            aboutGroupTitiledPane.setDisable(true);
            aboutGroupAdminTitledPane.setDisable(false);
            idArgumentField.setDisable(true);
        } else if (commandName.equals("update")) {
            aboutGroupTitiledPane.setDisable(false);
            aboutGroupAdminTitledPane.setDisable(false);
            idArgumentField.setDisable(false);
        } else if (commandName.matches("remove_by_id")) {
            aboutGroupTitiledPane.setDisable(true);
            aboutGroupAdminTitledPane.setDisable(true);
            idArgumentField.setDisable(false);
        } else {
            aboutGroupTitiledPane.setDisable(true);
            aboutGroupAdminTitledPane.setDisable(true);
    ...
    @FXML
    void changeToAuth(ActionEvent event) throws IOException {
        ...
        pane.setPrefSize(350, 390);

        primaryStage.show();


        HiPanelController controller = loader.getController();
        commandReceiver.setHiPanelController(controller);
